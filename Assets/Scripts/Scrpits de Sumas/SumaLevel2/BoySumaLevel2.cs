...
public class BoySumaLevel2 : MonoBehaviour
{
    ...
    private GameLevel2 _gameController;
    ...
    void Start()
    {
        ...
        _gameController = FindObjectOfType<GameLevel2>();
  ...
  void Update()
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            _gameController.NuevaOperacion("Cuanto es 1 + 4?");
        ...
        {
            _gameController.NuevaOperacion("Cuanto es 8 + 3?");
            Destroy(collision.gameObject);
            sonidos.Punto();
            if (TextoFlotante)
            {
        ...
        if (collision.gameObject.CompareTag("11Correcto"))
        {
            _gameController.NuevaOperacion("Cuanto es 7 + 3?");
            Destroy(collision.gameObject);
            sonidos.Punto();
            if (TextoFlotante)
            {
