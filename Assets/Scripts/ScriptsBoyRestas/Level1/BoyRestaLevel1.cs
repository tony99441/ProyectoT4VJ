...
public class BoyRestaLevel1 : MonoBehaviour
{
    ...
    private GameRestaLevel1 _gameController;
    ...
    void Start()
    {
        ...
        _gameController = FindObjectOfType<GameRestaLevel1>();
   ...
   void Update()
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            _gameController.NuevaOperacion("Cuanto es 10 - 5?");
        ...
        if (collision.gameObject.CompareTag("5Correcto"))
        {
            _gameController.NuevaOperacion("Cuanto es 7 - 6?");
            Destroy(collision.gameObject);
            sonidos.Punto();
            if (TextoFlotante)
            {
        ...
        if (collision.gameObject.CompareTag("1Correcto"))
        {
            _gameController.NuevaOperacion("Cuanto es 12 - 6?");
            Destroy(collision.gameObject);
            sonidos.Punto();
            if (TextoFlotante)
            {
        ...
        if (collision.gameObject.CompareTag("6Correcto"))
        {
