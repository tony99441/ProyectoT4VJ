...
public class BoyRestaLevel3 : MonoBehaviour
{
    ...
    private GameRestaLevel3 _gameController;
    ...
    void Start()
    {
        ...
        _gameController = FindObjectOfType<GameRestaLevel3>();
   ...
   void Update()
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            Debug.Log("Pasa al siguiente nivel");
            // Que se desaparzcan los numeros 
